<template>
  <b-container>
    <b-row v-loading="loading">
      <b-col cols="12" md="3" class="mb-5" v-for="(item,index) in proj" :key="index">
        <b-card
          :title="item.title"
          title-tag="h6"
          :img-src="src"
        ...
        >
          <hr />
          <b-card-text style="font-size:0.8rem" v-b-modal.modal-1 v-html="item.content?item.content:'11111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111'"></b-card-text>

          <b-button :href="item.linkUrl" target="_blank" variant="outline-dark">VIEW</b-button>
          <b-button
...
import mockproj from "@/db/project";
export default {
  created() {
    this.getProject();
  },
  data() {
    return {
      loading: false,
      proj: mockproj,
      src: require("../../assets/project/pexels-photo-1292998.jpeg")
    };
  },
  methods: {
    getProject() {
      this.loading = true;
      project.getProject().then(response => {
